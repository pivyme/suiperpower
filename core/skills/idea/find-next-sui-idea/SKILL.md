...
description: Help the user pick a Sui product idea from a curated corpus, or stress-test their own. Use when the user says "what should I build on Sui", "find me a Sui idea", "I do not know what to build", "Sui Overflow idea", "give me a hackathon idea", "Sui native opportunities", "pick my next project", or "I need an idea for Sui".
---
